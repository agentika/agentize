...
from agentize.prompts.summary import scrape_summarize_agent
from agentize.prompts.summary import summarize_agent
...
class OpenAIAgent:
    def __init__(self) -> None:
        self.agent = Agent(
            ...
            tools=[scrape_summarize_agent, summarize_agent],
        )
